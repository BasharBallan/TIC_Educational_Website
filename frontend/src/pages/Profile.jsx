      ...
      <Card>
        ...
        {userData.role === "student" && (
          <div style={{ marginTop: "15px" }}>
            ...
            <p style={{ margin: "0 0 8px 0", color: "#555" }}>
              <strong>Student Number:</strong> {userData.studentData?.studentNumber}
            </p>

            <p style={{ margin: "0 0 8px 0", color: "#555" }}>
              <strong>Year:</strong> {userData.studentData?.year}
            </p>

            <p style={{ margin: "0 0 8px 0", color: "#555" }}>
              <strong>Semester:</strong> {userData.studentData?.semester}
            </p>
          </div>
        )}
